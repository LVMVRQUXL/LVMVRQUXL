...
- [Kotlin/api-guidelines]: Suggested change related to operator overloads on
  the API guidelines for JVM library creators (see issue
  [#22][kotlin/api-guidelines#22]). Also fixed a typo in the documentation
  about using member and extension functions appropriately (see PR
  [#23][kotlin/api-guidelines#23]).
